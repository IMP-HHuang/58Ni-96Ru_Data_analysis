...
//input file
#define INPUTFILEPATH "../data/eventBHCal/"
#define INPUTFILENAME "event"
//input tree
#define INPUTTREENAME "tree"

// output file
#define OUTPUTFILEPATH "../data/Recoil-isomer-BHCal/"
#define OUTPUTFILENAME "Recoil"
...
//Delayed gamma
const Double_t DelayedGammaTimeMin = 0.0; //us
const Double_t DelayedGammaTimeMax = 0.4; //us
